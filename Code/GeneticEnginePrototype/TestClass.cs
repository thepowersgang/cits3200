...
public class TestClass
{
	public TestClass()
	{
        ...
        MaxFitnessGenerator AMaxFitnessGenerator;
        ...
        public void TestE1() {
                RoadNetworkEvaluator() RNE = new RoadNetworkEvaluator();
                ...
                for (int i = 0; i < numberofroadnetworks; i++) {
                     Console.WriteLine("Checking individual: " + i + ", Fitness: " + RNE.evaluate(individuals.get(i).individual));
                }
        }
