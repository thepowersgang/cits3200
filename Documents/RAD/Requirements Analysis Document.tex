...
\begin{figure}[h!]
 ...
 \includegraphics{../GeneticEngineCoreDetail.png}
\end{figure}

\begin{figure}[h!]
 \caption{Namespace: GeneticEnginePlugin}
 \includegraphics{../GeneticEnginePluginDetail.png}
\end{figure}

\begin{figure}[h!]
 \caption{Namespace: GeneticEngineSupport}
 \includegraphics{../GeneticEngineSupportDetail.png}
\end{figure}

\begin{figure}[h!]
 \caption{Namespace: RoadNetworkFinder}
 \includegraphics{../RoadNetworkFinderDetail.png}
\end{figure}

\begin{figure}[h!]
 \caption{GeneticEngineCore/Plugin/Support Dependencies}
 \includegraphics[scale=0.25]{../GeneticEngineCorePluginSupport.png}
\end{figure}

\begin{figure}[h!]
 \caption{RoadNetworkFinder Dependencies}
 \includegraphics[scale=0.25]{../RoadNetworkFinder.png}
\end{figure}

\begin{figure}[h!]
 \caption{RoadNetworkFinderGUI Dependencies}
 \includegraphics[scale=0.25]{../RoadNetworkFinderGUI.png}
\end{figure}

\begin{figure}[h!]
 \caption{RoadNetworkVisualiser Dependencies}
 \includegraphics[scale=0.25]{../RoadNetworkVisualiser.png}
\end{figure}
...
\begin{figure}[h!]
 ...
 \includegraphics{../Visualiser.png}
\end{figure}
