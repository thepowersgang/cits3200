...
\begin{figure}[h!]
 \caption{GeneticEngineCore Overview}
 \includegraphics[width=0.75\textwidth]{../GeneticEngineCore.jpg}
 \caption{GeneticEngineCore Class Detail}
 \includegraphics[width=0.75\textwidth]{../GeneticEngineCoreDetail.png}
\end{figure}
